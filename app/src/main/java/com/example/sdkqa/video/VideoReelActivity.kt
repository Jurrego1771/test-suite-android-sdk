    ...
    private fun createReelsCallback(): MediastreamPlayerCallback {
        return object : MediastreamPlayerCallback {
            override fun playerViewReady(msplayerView: PlayerView?) {
                ...
                TestEventBus.record(
                    name = "VideoReel.playerViewReady",
            ...
            override fun onReady() {
                Log.d(TAG, "onReady")
                TestEventBus.record(name = "VideoReel.onReady")
            }

            override fun onPlay() {
                Log.d(TAG, "onPlay")
                TestEventBus.record(name = "VideoReel.onPlay")
            }

            override fun onPause() {
                Log.d(TAG, "onPause")
                TestEventBus.record(name = "VideoReel.onPause")
            }
            ...
            override fun onBuffering() {
                ...
                TestEventBus.record(name = "VideoReel.onBuffering")
            }

            override fun onError(error: String?) {
                Log.e(TAG, "onError: $error")
                TestEventBus.record(name = "VideoReel.onError", data = mapOf("error" to (error ?: "")))
            }
